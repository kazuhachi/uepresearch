...
?>
		...
		<div class="inner-content">
			...
			<div class="sub-inner-content">
				<div class="table-nav-top">
					<div class="data-num">
						<label for="data-num-item">Colleges</label>
					</div>
					<button class="additional-details-add-button pop-up-button" id="	utton" data-pop-up-target-id="pop-up-college"><i class="fa fa-plus" aria-hidden="true"></i>Add</button>
				</div>
	...
	<div class="pop-up-container" id="pop-up-college">
		<div class="pop-container col-md-6 col-sm-8  col-lg-5 p-0 mx-4" >
			<div class="form-validation">
				<div class="pop-up-header">	
					Add college <span class="icon-guide"><i class="far fa-plus-square"></i></span>
					<span class="close-pop-up" tooltip-title="Close">
						<i class="fas fa-times"></i>
					</span>
				</div>
				<div class="pop-up-body">
						<label for="title">College name</label> <span class="error-msg"></span>
						<input type="text" class="input-add-college-name" name="college-name">
				</div>
				<div class="pop-up-footer">
					<input type="button" id="add-college-button" class="confirm-form-button" name="Confirm" value="Confirm">
	...
	<div class="pop-up-container" id="pop-up-edit-college">
		<div class="pop-container col-md-6 col-sm-8  col-lg-5 p-0" >
			<div class="form-validation">
				<div class="pop-up-header">	
					Edit college <span class="icon-guide"><i class="far fa-edit"></i></span>
					<span class="close-pop-up" tooltip-title="Close">
						<i class="fas fa-times"></i>
					</span>
				</div>
				<div class="pop-up-body">
						<label for="title">College name</label> <span class="error-msg"></span>
						<input type="text" id="input-edit-college-name" class="input-edit-college-name" name="college-name">
				</div>
				<div class="pop-up-footer">
					<input type="button" id="edit-college-button" class="confirm-form-button" name="Update" value="Update">
					<input type="button" class="reset-form-button" name="" value="Cancel">
				</div>
			</div>
		</div>
